using System;
using JK.Captcha.Contracts;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Filters;
using Microsoft.Extensions.DependencyInjection;

namespace JK.Captcha
{
    /// <summary>
    ...
    public class ValidateCaptchaAttribute : TypeFilterAttribute
    {
        ...
        private class ValidateCaptchaFilter : IActionFilter
        {
            ...
            {
                var captchaOptions = context.HttpContext.RequestServices.GetService<CaptchaOptions>();
                if (captchaOptions.Enable == false)
                {
                    return true;
                }
