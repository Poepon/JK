...
namespace JK.Books
{
    public class TianLaiBookCrawler : CrawlerBase, IBookCrawler
    {
        public TianLaiBookCrawler(IHttpClientFactory httpClientFactory) : base(httpClientFactory)
        {
            
        }

        public override string SearchUrlFormat => "https://www.23txt.com/search.php?keyword={0}";

        public override string Source => BookSource.TianLai;

        public override string Host => "https://www.23txt.com";
        //搜索间隔不限
    ...
    public class TianLaiContentCrawler : ContentCrawlerBase, IContentCrawler
    {
        public TianLaiContentCrawler(IHttpClientFactory httpClientFactory) : base(httpClientFactory)
        {
