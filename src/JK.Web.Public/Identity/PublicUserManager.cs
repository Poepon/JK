...
{
    public class PublicUserManager : UserManager<Customer>, IDomainService
    {
        ...
        protected PublicUserStore UserStore { get; }
        ...
        public virtual Task<Customer> FindByNameOrEmailAsync(string userNameOrEmailAddress)
        {
        ...
        public virtual Task<Customer> FindByNameOrEmailAsync(int? tenantId, string userNameOrEmailAddress)
        {
        ...
        public virtual async Task<Customer> GetUserByIdAsync(long userId)
        {
        ...
        public override async Task<IdentityResult> UpdateAsync(Customer user)
        {
            var result = await CheckDuplicateUsernameOrEmailAddressAsync(user.Id, user.UserName, user.Email);
            if (!result.Succeeded)
            {
        ...
        public override async Task<IdentityResult> DeleteAsync(Customer user)
        {
            return await base.DeleteAsync(user);
        }

        public virtual async Task<IdentityResult> ChangePasswordAsync(Customer user, string newPassword)
        {
        ...
        public override async Task<IList<string>> GetValidTwoFactorProvidersAsync(Customer user)
        {
